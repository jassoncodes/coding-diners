...
namespace mergeFile
{
    class Program
    {
        ...
        {
            string directoryPath = @"E:\RECURSOS ROBOT\DATA\BUSQUEDA_JUICIOS\ARCHIVOS\HISTORIALES"; // Ruta del directorio donde se encuentran los archivos Excel
            ...
            if (System.IO.File.Exists(outputFilePath))
            {
                ...
                foreach (string filePath in excelFiles)
                {
                    ...
                    if (sheet != null)
                    {
                        ...
                        for (int row = 4; row <= lastRowSource; row++) // Comenzar desde la fila 4 (jpincay)
            ...
            else
            {
                ...
                int rowIndex = 4; // Comenzar desde la fila 4 (jpincay)
                ...
                foreach (string filePath in excelFiles)
                {
                    ...
                    if (sheet != null)
                    {
                        ...
                        for (int row = 4; row <= lastRow; row++) // Comenzar desde la fila 4 (jpincay)
